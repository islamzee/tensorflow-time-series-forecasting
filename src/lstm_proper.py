...
def run_LSTM(regionName):
    switcher = {
        'NYISO' :  ['Name', 'LONGIL', 'Time Stamp'],
        'PJM' : ['Name', 'PJM', 'Time Stamp'],
        'CAISO' : ['hub', 'TH_NP15', 'Date']
    }
    # in case of ISONE, just append the csv's

    input = prepareDataFor(regionName, switcher[regionName][0], switcher[regionName][1], switcher[regionName][2])
    print(input.shape)
    ...
    print('xAxis ready, going to plot...')
